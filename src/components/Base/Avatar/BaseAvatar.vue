<script lang="ts">
import { BaseAvatarColors, type BaseAvatarColor } from './BaseAvatar';
import { computed, h, type HTMLAttributes, type PropType } from 'vue';

export default {
    props: {
        color: String as PropType<BaseAvatarColor>,
        size: {
            type: Number,
            default: 40
        }
    ...
    setup(props, { slots }) {
        ...
        const styles = computed(() => {
            ...
            if (props.color && !BaseAvatarColors.includes(props.color)) {
